...
const FIELD_TYPES = {
  ...
  // Home Screen Content (homepage sections, edited in admin)
  home_collection_eyebrow: { type: sql.VarChar, maxLength: 255 },
  home_collection_title: { type: sql.VarChar, maxLength: 255 },
  home_collection_json: { type: sql.VarChar, maxLength: sql.MAX },
  home_new_arrivals_eyebrow: { type: sql.VarChar, maxLength: 255 },
  home_new_arrivals_title: { type: sql.VarChar, maxLength: 255 },
  home_new_arrivals_subtitle: { type: sql.VarChar, maxLength: sql.MAX },
  home_new_arrivals_count: { type: sql.Int },
  home_new_arrivals_cols: { type: sql.Int },
  home_reviews_eyebrow: { type: sql.VarChar, maxLength: 255 },
  home_reviews_title: { type: sql.VarChar, maxLength: 255 },
  home_reviews_subtitle: { type: sql.VarChar, maxLength: sql.MAX },
  home_faqs_title: { type: sql.VarChar, maxLength: 255 },
  home_faqs_subtitle: { type: sql.VarChar, maxLength: sql.MAX },
  home_spotlight_title: { type: sql.VarChar, maxLength: 255 },
  home_style_by_hc_title: { type: sql.VarChar, maxLength: 255 },
  footer_facebook_url: { type: sql.VarChar, maxLength: 1000 },
  footer_instagram_url: { type: sql.VarChar, maxLength: 1000 },
  footer_youtube_url: { type: sql.VarChar, maxLength: 1000 },
  footer_quick_links_json: { type: sql.VarChar, maxLength: sql.MAX },
  footer_support_links_json: { type: sql.VarChar, maxLength: sql.MAX },
  footer_copyright_text: { type: sql.VarChar, maxLength: 255 },
...
const INSERT_FIELDS = [
  ...
  'home_style_by_hc_title',
  'footer_facebook_url',
  'footer_instagram_url',
  'footer_youtube_url',
  'footer_quick_links_json',
  'footer_support_links_json',
